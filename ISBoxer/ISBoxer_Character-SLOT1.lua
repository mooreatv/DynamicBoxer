isboxer.Character.Name = "SLOT1";
isboxer.Character.ActualName = "SLOT1";
isboxer.Character.QualifiedName = "SLOT1";
...
function isboxer.Character_LoadBinds()
	if (isboxer.CharacterSet.Name=="DYNAMIC_DUO") then
		...
		isboxer.SetMacro("InviteTeam","ALT-CTRL-SHIFT-I","/invite SLOT2\n",nil,nil,nil,1);
...
isboxer.Output("Character 'SLOT1' activated");
